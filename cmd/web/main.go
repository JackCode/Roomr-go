...
import (
	...
	"github.com/jackcode/roomr-go/pkg/models/mysql"
...
func main() {
	...
	dsn := flag.String("dsn", "root:cvgck@/roomr_dev?parseTime=true", "MySQL data source name")
